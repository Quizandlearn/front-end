...
const initialState = {
  // quand tu recharges la page, quand les données de l'utilisateur existent,
  // on les récupère du local storage
...
// HOOK USE REDUCER = méthode qui va permettre de mettre à jour
// l'"initial value" de l'état global de l'application
