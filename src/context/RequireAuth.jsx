...
// 1-- vérifier que le token de l'utilisateur est valide,
// s'il n'est plus valide => le renvoyer vers le page de LOGIN
// 2---faire en sorte que les routes login et connexion ne
// soient plus accessible lorsque que l'utilisateur est connecté
...
const RequireAuth = ({ onlyPublic }) => {
  ...
  if (onlyPublic) {
    ...
    <Navigate to="/quizzes" state={{ from: location }} replace />;
  }
